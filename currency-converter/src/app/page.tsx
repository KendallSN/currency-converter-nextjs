...
export default function CurrencyConverter() {
  ...
  // Save state to localStorage whenever dependencies change
  useEffect(() => {
  ...
  // Set default currencies when the list of currencies is updated
  useEffect(() => {
    if (currencies.length > 0) {
      setFromCurrency((prev) => (currencies.includes(prev) ? prev : currencies[0]));
      setToCurrency((prev) => (currencies.includes(prev) ? prev : currencies[1] || currencies[0]));
    }
  }, [currencies]);
